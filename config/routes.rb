Rails.application.routes.draw do
  ...
  delete "/cities/:city_id/posts/:post_id", to:"post_cities#destroy", as:"post_city_destroy"

  get "/cities/:city_id/posts/:post_id/comments", to:"comments#new", as: "new_comment"
  post "/cities/:city_id/posts/:post_id/comments", to:"comments#create", as:"comments"
